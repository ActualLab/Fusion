...
describe('Fusion RPC Reconnection', () => {
    ...
    it('should NOT invalidate stage-3 compute calls on disconnect', async () => {
        ...
        const outboundCall = clientPeer.call(
            ...
            {
                callTypeId: 1,
                outboundCallFactory: (id: number, m: string) =>
    ...
    it('should invalidate compute calls on host switch', async () => {
        ...
        const callA = clientPeer.call('CounterService.getCount:2', ['x'], {
            callTypeId: 1,
            outboundCallFactory: (id: number, m: string) =>
                new RpcOutboundComputeCall(id, m),
        }) as RpcOutboundComputeCall;
        ...
        const callB = clientPeer.call('CounterService.getCount:2', ['x'], {
            callTypeId: 1,
            outboundCallFactory: (id: number, m: string) =>
                new RpcOutboundComputeCall(id, m),
        }) as RpcOutboundComputeCall;
    ...
    it('should handle compute calls with invalidation after reconnect', async () => {
        ...
        // Make a compute call
        const call1 = clientPeer.call('CounterService.getCount:2', ['z'], {
            callTypeId: 1,
            outboundCallFactory: (id: number, m: string) =>
                new RpcOutboundComputeCall(id, m),
        }) as RpcOutboundComputeCall;
        ...
        const call2 = clientPeer.call('CounterService.getCount:2', ['z'], {
            callTypeId: 1,
            outboundCallFactory: (id: number, m: string) =>
                new RpcOutboundComputeCall(id, m),
        }) as RpcOutboundComputeCall;
