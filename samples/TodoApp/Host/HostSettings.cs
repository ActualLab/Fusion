...
public class HostSettings
{
    ...
    public string UsePostgreSql { get; set; } = "";
        // "Server=127.0.0.1;Database=fusion_todoapp1_{0:Shard};Port=5432;User Id=postgres;Password=postgres";
    public string UseSqlServer { get; set; } = "";
        // "Data Source=127.0.0.1;Initial Catalog=fusion_todoapp1_{0:Shard};Integrated Security=False;User ID=sa;Password=SqlServer1";
