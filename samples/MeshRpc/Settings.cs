...
public static class HostFactorySettings
{
    ...
    public static readonly double MinHostCount = 2;
...
public static class TestSettings
{
    ...
    public static readonly Sampler UseFusionSampler = Sampler.Always; // Sampler.RandomShared(0.5);
    ...
    public static readonly bool MustRunOnServerHost = false;
