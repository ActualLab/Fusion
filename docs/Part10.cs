...
#region Part10_PostMessageCommand
...
public static class Part10
{
    ...
    {
        WriteLine("Part 10: Multi-Host Invalidation and CQRS with Operations Framework");
        WriteLine();
    ...
    #region Part10_AddDbContextServices
...
{
    #region Part10_InvalidatingHandler
