...
Source File: /tutorial/mdsource/Part02.source.md
...
<a id='snippet-Part02_CounterService'></a>
```cs
...
<a id='snippet-Part02_CaptureComputed'></a>
```cs
...
<a id='snippet-Part02_InvalidateComputed1'></a>
```cs
var counters = CreateServices().GetRequiredService<CounterService>();
var computed = await Computed.Capture(() => counters.Get("a"));
WriteLine($"computed: {computed}");
...
<a id='snippet-Part02_InvalidateComputed2'></a>
```cs
var counters = CreateServices().GetRequiredService<CounterService>();
var computed = await Computed.Capture(() => counters.Get("a"));
WriteLine($"computed: {computed}");
...
<a id='snippet-Part02_IncrementCounter'></a>
```cs
var counters = CreateServices().GetRequiredService<CounterService>();
