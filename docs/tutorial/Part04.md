...
Source File: /tutorial/mdsource/Part04.source.md
...
<a id='snippet-Part04_CommonServices'></a>
```cs
...
<a id='snippet-Part04_HostServices'></a>
```cs
...
<a id='snippet-Part04_CreateXxx'></a>
```cs
...
<a id='snippet-Part04_ReplicaService'></a>
```cs
...
<a id='snippet-Part04_LiveStateFromReplica'></a>
```cs
using var host = CreateHost();
await host.StartAsync();
WriteLine("Host started.");
