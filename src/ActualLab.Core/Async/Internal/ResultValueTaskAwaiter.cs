...
/// <summary>
/// An awaiter that returns a <see cref="Result{T}"/> of <see cref="Unit"/> from a <see cref="ValueTask"/>.
/// </summary>
...
/// <summary>
/// An awaiter that returns a <see cref="Result{T}"/> from a <see cref="ValueTask{TResult}"/>.
/// </summary>
[StructLayout(LayoutKind.Auto)]
