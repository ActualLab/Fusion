...
/// <summary>
/// A compact <see cref="IRefHashSetSlim{T}"/> that stores up to 4 reference items inline
    ...
    where T : class
{
    ...
    public readonly int Count {
        get {
            ...
            if (_tuple.Item4 is null) return 3;
            return 4;
        }
    }
    ...
    public bool Remove(T item)
    {
        ...
        // Item 4
        if (_tuple.Item4 is null) return false;
    ...
    public readonly IEnumerable<T> Items {
        get {
            ...
            if (_tuple.Item4 is null) yield break;
    ...
    public readonly void Apply<TState>(TState state, Action<TState, T> action)
    {
        ...
        if (_tuple.Item4 is null) return;
    ...
    public readonly TState Aggregate<TState>(TState state, Func<TState, T, TState> aggregator)
    {
        ...
        if (_tuple.Item4 is null) return state;
