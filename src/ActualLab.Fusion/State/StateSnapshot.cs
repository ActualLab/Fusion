...
public interface IStateSnapshot
{
    ...
    ComputedBase LastNonErrorComputed { get; }
    int UpdateCount { get; }
    int ErrorCount { get; }
    int RetryCount { get; }
    bool IsInitial { get; }
...
public class StateSnapshot<T> : IStateSnapshot<T>
{
    ...
    ComputedBase IStateSnapshot.Computed => Computed;
    ComputedBase IStateSnapshot.LastNonErrorComputed => LastNonErrorComputed;
