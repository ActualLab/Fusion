...
{
    /// <summary>
    /// Minimum time (in seconds) for any produced <see cref="ComputedBase"/> instance to stay in RAM.
    /// <code>double.NaN</code> means "use default".
    /// </summary>
    /// <remarks>
    /// <para>
    /// In fact, it's a duration of a period during which a strong reference to this
    /// <see cref="ComputedBase"/> instance is maintained via <see cref="Timeouts"/>.
    /// </para>
    /// <para>
    ...
    /// <summary>
    /// Auto-invalidation delay (in seconds) for any produced <see cref="ComputedBase"/> instance
    ...
    /// <summary>
    /// Invalidation delay (in seconds) for any produced <see cref="ComputedBase"/> instance.
    /// <code>double.NaN</code> means "use default".
    /// </summary>
