...
public partial record AuthBackend_SetupSession(
    ...
    [property: DataMember, MemoryPackOrder(1), Key(1)] string IPAddress,
    [property: DataMember, MemoryPackOrder(2), Key(2)] string UserAgent,
    [property: DataMember, MemoryPackOrder(3), Key(3)] ImmutableOptionSet Options
...
public partial record AuthBackend_SignIn(
    [property: DataMember, MemoryPackOrder(0), Key(0)] Session Session,
    [property: DataMember, MemoryPackOrder(1), Key(1)] User User,
    [property: DataMember, MemoryPackOrder(2), Key(2)] UserIdentity AuthenticatedIdentity
