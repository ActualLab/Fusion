...
public sealed partial record RpcMessage
{
    ...
    [DataMember(Order = 3), MemoryPackOrder(3), Key(3)] public ReadOnlyMemory<byte> ArgumentData { get; init; }
    ...
    public RpcMessage(byte callTypeId, long relatedId, RpcMethodRef methodRef, ReadOnlyMemory<byte> argumentData, RpcHeader[]? headers)
    {
